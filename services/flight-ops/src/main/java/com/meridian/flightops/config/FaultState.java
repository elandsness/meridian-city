...
/**
 * Runtime fault-injection state for flight-ops, toggled via POST /admin/fault by
 * demo-control-api (the unified "Business Failures" control). When enabled, a share of
 * departing flights are cancelled at boarding (see
 * {@link com.meridian.flightops.service.FlightLifecycleScheduler}), emitting
 * flight.cancelled so the Aircraft Turnaround business flow shows a failure branch +
