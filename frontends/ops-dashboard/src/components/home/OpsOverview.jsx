...
// The standard ops overview: KPI row + requests-over-time chart. Kept as one module
// so the default (city) ops home is unchanged; industries compose their own set.
    ...
    <>
      {kpisError ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-3">
          <KpiTile label="Requests Today" value={kpisLoading ? '…' : kpis?.requests_today} color="cyan" />
          <KpiTile label="Open Requests" value={kpisLoading ? '…' : kpis?.requests_open} color="yellow" />
          <KpiTile label="Resolved Today" value={kpisLoading ? '…' : kpis?.requests_resolved_today} color="green" />
          <KpiTile
          ...
          <KpiTile
            ...
            color="cyan"
          />
          <KpiTile label="AI Chats Today" value={kpisLoading ? '…' : kpis?.ai_chats_today} color="green" />
        </div>
      )}
